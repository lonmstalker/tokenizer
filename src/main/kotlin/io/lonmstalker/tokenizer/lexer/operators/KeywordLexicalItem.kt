...
class KeywordLexicalItem(
    val type: Tokens.Keywords,
    private val isSupportFunction: Predicate<KeywordLexicalItem>
) : LexicalItem() {

    override fun getLexicalType(): LexicalType = LexicalType.KEYWORD
